...
const PortfolioSection = () => {
  return (
    <div name="Portfolio" className="w-full md:h-screen bg-black text-white flex  flex-col items-start justify-start  h-full ">
      ...
      <div className="grid   px-24 md:grid-cols-3  w-full h-full grid-cols-1   md:py-10 gap-8 md:max-w-screen-lg md:mx-auto md:justify-between">
        <div className=" flex flex-col">
          <img src={logo}  alt='picName' width={200} height={70}></img>
